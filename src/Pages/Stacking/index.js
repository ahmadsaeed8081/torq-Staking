...
const Stacking = (props) => {
  ...
  const APRList = [
    { value: "0", lbl: "1 Years" ,APR: "100%"},
    { value: "1", lbl: "2 Years"  ,APR: "250%"},
    { value: "2", lbl: "3 Years"  ,APR: "625%"},
...
let count=0;
    ...
    abi: cont_abi,
    functionName: 'Stake',
    args: [Convert_To_wei(stakeAmount),selectedAPR.value,props.ref_add],
    // gas:500000,
...
useEffect(()=>{
  ...
  {
    set_TokenBalance(props.TokenBalance)
  ...
  async function stake()
  {
    ...
    if(Number(TokenBalance)/10**18 < Number(stakeAmount))
    {
          ...
          <div className="stacking-box">
            ...
            <div className="flex justify-center items-center mt-10">
              <div className="st-box flex flex-col">
                ...
                {selectedTab === "Staking" ? (
                  <div className="staking-part flex flex-col">
                    ...
                    <div className="form flex flex-col p-5 gap-4 mt-6 ">
                      ...
                      <div className="input_field flex flex-col mb-3">
                        <div className="flex items-center justify-between gap-2 mb-1">
                          <h1 className="lbl">Amount: (Minimum 10 Token)</h1>
                          {/* <h1 className="lbl mb-2">Amount (Min 1 Token - Max 2500Token)</h1> */}

                          <h1 className="lbl">Balance: {TokenBalance>0?(Number(TokenBalance)/10**18).toFixed(2):0} Token</h1>
                        </div>
                        <div className="input-box flex items-center">
                          ...
                          min={0}
                          value={stakeAmount}
                          max={TokenBalance>0?(Number(TokenBalance)/10**18):0}
                          onChange={(e)=>setStakedAmount(e.target.value)}
                          />


                          <div className="flex items-center gap-1">
                            <h1 className="plp-lbl">Token</h1>
                            <div className="max-lbl"onClick={(e)=>setStakedAmount((Number(TokenBalance)/10**18))} >MAX </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="field-hdr flex items-center justify-between"style={{ paddingTop: 20 }}>
                ...
                {
              selectedAmount && Number(props.curr_time) > Number(selectedAmount[1])?(
                <button className="btn button" disabled={isLoading_unstake} onClick={(e) =>{unstaking()} }>
                ...
                <button className="btn button" style={{ background:"grey",  border:"none"}}>
                Unstake
              </button>
              )
