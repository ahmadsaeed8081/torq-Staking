...
const Main = ({loader,totalbusiness,totalusers,totalReward,totalInvestment,set_ref_func,totalEarning,directs,team,set_regAddress,regAddress,totalRefIncome,test , minWithdraw, maxWithdraw}) => {
 ...
 const waitForTransaction4 = useWaitForTransaction({
  ...
  const dashboardList = [
    ...
    },
    {
      ...
      price: (Number(totalbusiness)/(10**18)).toFixed(2),
    },
    {
  ...
  return (
    <Wrapper>
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <WithdrawModal calltest={calltest} withdraw={withdraw} minWithdraw={minWithdraw} maxWithdraw={maxWithdraw} totalEarning={totalEarning} address={address}/>
      </Modal>
